...
## [**2. 멀티스레딩 & 좌표 기반 Min-Max 알고리즘 구현**](#B-멀티스레딩--좌표-기반-min-max-알고리즘-구현)
...
## [**3. 머티리얼 기반 UI 구현**](#C-머티리얼-기반-ui-구현)
...
## [**4. 확장성을 고려한 객체 지향적 구조**](#D-확장성을-고려한-객체-지향적-구조)
